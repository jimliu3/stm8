...
#define ENABLE_TIM2_OC1Init       0  /* Disable OC1 */
#define ENABLE_TIM2_OC3Init       0  /* Disable OC1 */
#define ENABLE_TIM2_PWMIConfig		0  /* Disable TIM2_PWMIConfig*/
#define ENABLE_TIM2_UpdateDisableConfig 0 /*TIM2_UpdateDisableConfig*/
#define ENABLE_TIM2_ADV_FEATURE    0 /*void TIM2_SelectOnePulseMode(...)
																				void TIM2_PrescalerConfig(...)
																				void TIM2_ForcedOC1Config(...)
																				void TIM2_ForcedOC2Config(...)
																				void TIM2_ForcedOC3Config(...)
																				void TIM2_ARRPreloadConfig(...)*/
																				
#define ENABLE_TIM2_OC1PreloadConfig 0 /*TIM2_OC1PreloadConfig*/
#define ENABLE_TIM2_OC3PreloadConfig 0 /*TIM2_OC3PreloadConfig*/
#define ENABLE_TIM2_EXTENDED_FEATURES    0
#define ENABLE_TIM2_SelectOCxM				0 /*TIM2_SelectOCxM*/
#define ENABLE_TIM2_SetAutoreload		0 /*TIM2_SetAutoreload*/
#define ENABLE_TIM2_SetCompareX			0 /*TIM2_SetCompareX*/
#define ENABLE_TIM2_SetICXPrescaler 0 /*TIM2_SetICXPrescaler*/
#define ENABLE_TIM2_GetCaptureX			0 /*TIM2_GetCaptureX*/
#define ENABLE_TIM2_GetPrescaler		0 /*TIM2_GetPrescaler*/
#define ENABLE_TIM2_GetFlagStatus		0 /*TIM2_GetFlagStatus*/
#define ENABLE_TIM2_ClearFlag				0	/*TIM2_ClearFlag*/
#define ENABLE_TIM2_GetITStatus			0	/*TIM2_GetITStatus*/
...
#endif // ENABLE_TIM2_OC3Init

#if ENABLE_TIM2_PWMIConfig
/**
...
#if ENABLE_TIM2_UpdateDisableConfig
/**
...
#endif //ENABLE_TIM2_UpdateDisableConfig

#if ENABLE_TIM2_ADV_FEATURE    
/**
...
#endif //ENABLE_TIM2_ADV_FEATURE    

#if ENABLE_TIM2_OC1PreloadConfig
/**
...
#endif //ENABLE_TIM2_OC1PreloadConfig
...
#if ENABLE_TIM2_OC3PreloadConfig
/**
...
#if ENABLE_TIM2_EXTENDED_FEATURES
/**
...
#endif //ENABLE_TIM2_EXTENDED_FEATURES
...
#endif //ENABLE_TIM2_SetAutoreload

#if ENABLE_TIM2_SetCompareX
/**
...
#if ENABLE_TIM2_SetICXPrescaler
/**
...
#endif //ENABLE_TIM2_SetICXPrescaler


#if ENABLE_TIM2_GetCaptureX
/**
...
#endif //ENABLE_TIM2_GetCaptureX
#if ENABLE_TIM2_GetPrescaler
/**
...
#endif //ENABLE_TIM2_GetPrescaler

#if ENABLE_TIM2_GetFlagStatus
/**
...
#endif //ENABLE_TIM2_GetFlagStatus

#if ENABLE_TIM2_ClearFlag
/**
...
#endif //ENABLE_TIM2_ClearFlag

#if ENABLE_TIM2_GetITStatus
/**
