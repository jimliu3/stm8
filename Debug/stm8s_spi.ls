 ...
 394                     ; 76     assert_param(IS_SPI_BAUDRATE_PRESCALER_OK(BaudRatePrescaler));
 396                     ; 77     assert_param(IS_SPI_MODE_OK(Mode));
 398                     ; 78     assert_param(IS_SPI_POLARITY_OK(ClockPolarity));
 400                     ; 79     assert_param(IS_SPI_PHASE_OK(ClockPhase));
 402                     ; 80     assert_param(IS_SPI_DATA_DIRECTION_OK(Data_Direction));
 404                     ; 81     assert_param(IS_SPI_SLAVEMANAGEMENT_OK(Slave_Management));
 406                     ; 82     assert_param(IS_SPI_CRC_POLYNOMIAL_OK(CRCPolynomial));
 408                     ; 85     SPI->CR1 = (uint8_t)((uint8_t)((uint8_t)FirstBit | BaudRatePrescaler) |
 408                     ; 86                     (uint8_t)((uint8_t)ClockPolarity | ClockPhase));
 ...
 418                     ; 89     SPI->CR2 = (uint8_t)((uint8_t)(Data_Direction) | (uint8_t)(Slave_Management));
 420  0025 7b09          	ld	a,(OFST+8,sp)
 421  0027 1a0a          	or	a,(OFST+9,sp)
 422  0029 c75201        	ld	20993,a
 423                     ; 91     if (Mode == SPI_MODE_MASTER)
 425  002c 7b06          	ld	a,(OFST+5,sp)
 426  002e a104          	cp	a,#4
 427  0030 2606          	jrne	L302
 428                     ; 93         SPI->CR2 |= (uint8_t)SPI_CR2_SSI;
 430  0032 72105201      	bset	20993,#0
 432  0036 2004          	jra	L502
 433  0038               L302:
 434                     ; 97         SPI->CR2 &= (uint8_t)~(SPI_CR2_SSI);
 436  0038 72115201      	bres	20993,#0
 437  003c               L502:
 438                     ; 101     SPI->CR1 |= (uint8_t)(Mode);
 440  003c c65200        	ld	a,20992
 441  003f 1a06          	or	a,(OFST+5,sp)
 442  0041 c75200        	ld	20992,a
 443                     ; 104     SPI->CRCPR = (uint8_t)CRCPolynomial;
 445  0044 7b0b          	ld	a,(OFST+10,sp)
 446  0046 c75205        	ld	20997,a
 447                     ; 105 }
 450  0049 5b03          	addw	sp,#3
 451  004b 81            	ret
 506                     ; 113 void SPI_Cmd(FunctionalState NewState)
 506                     ; 114 {
 507                     	switch	.text
 508  004c               _SPI_Cmd:
 512                     ; 116     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 514                     ; 118     if (NewState != DISABLE)
 516  004c 4d            	tnz	a
 517  004d 2706          	jreq	L532
 518                     ; 120         SPI->CR1 |= SPI_CR1_SPE; /* Enable the SPI peripheral*/
 520  004f 721c5200      	bset	20992,#6
 522  0053 2004          	jra	L732
 523  0055               L532:
 524                     ; 124         SPI->CR1 &= (uint8_t)(~SPI_CR1_SPE); /* Disable the SPI peripheral*/
 526  0055 721d5200      	bres	20992,#6
 527  0059               L732:
 528                     ; 126 }
 531  0059 81            	ret
 640                     ; 135 void SPI_ITConfig(SPI_IT_TypeDef SPI_IT, FunctionalState NewState)
 640                     ; 136 {
 641                     	switch	.text
 ...
 649                     ; 137     uint8_t itpos = 0;
 651                     ; 139     assert_param(IS_SPI_CONFIG_IT_OK(SPI_IT));
 653                     ; 140     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 655                     ; 143     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)SPI_IT & (uint8_t)0x0F));
 657  005c 9e            	ld	a,xh
 ...
 694  0085 81            	ret
 728                     ; 159 void SPI_SendData(uint8_t Data)
 728                     ; 160 {
 729                     	switch	.text
 730  0086               _SPI_SendData:
 734                     ; 161     SPI->DR = Data; /* Write in the DR register the data to be sent*/
 736  0086 c75204        	ld	20996,a
 737                     ; 162 }
 740  0089 81            	ret
 763                     ; 169 uint8_t SPI_ReceiveData(void)
 763                     ; 170 {
 764                     	switch	.text
 765  008a               _SPI_ReceiveData:
 769                     ; 171     return ((uint8_t)SPI->DR); /* Return the data in the DR register*/
 771  008a c65204        	ld	a,20996
 774  008d 81            	ret
 810                     ; 180 void SPI_NSSInternalSoftwareCmd(FunctionalState NewState)
 810                     ; 181 {
 811                     	switch	.text
 812  008e               _SPI_NSSInternalSoftwareCmd:
 816                     ; 183     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 818                     ; 185     if (NewState != DISABLE)
 820  008e 4d            	tnz	a
 821  008f 2706          	jreq	L163
 822                     ; 187         SPI->CR2 |= SPI_CR2_SSI; /* Set NSS pin internally by software*/
 824  0091 72105201      	bset	20993,#0
 826  0095 2004          	jra	L363
 827  0097               L163:
 828                     ; 191         SPI->CR2 &= (uint8_t)(~SPI_CR2_SSI); /* Reset NSS pin internally by software*/
 830  0097 72115201      	bres	20993,#0
 831  009b               L363:
 832                     ; 193 }
 835  009b 81            	ret
 858                     ; 200 void SPI_TransmitCRC(void)
 858                     ; 201 {
 859                     	switch	.text
 860  009c               _SPI_TransmitCRC:
 864                     ; 202     SPI->CR2 |= SPI_CR2_CRCNEXT; /* Enable the CRC transmission*/
 866  009c 72185201      	bset	20993,#4
 867                     ; 203 }
 870  00a0 81            	ret
 906                     ; 211 void SPI_CalculateCRCCmd(FunctionalState NewState)
 906                     ; 212 {
 907                     	switch	.text
 908  00a1               _SPI_CalculateCRCCmd:
 912                     ; 214     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 914                     ; 216     if (NewState != DISABLE)
 916  00a1 4d            	tnz	a
 917  00a2 2706          	jreq	L314
 918                     ; 218         SPI->CR2 |= SPI_CR2_CRCEN; /* Enable the CRC calculation*/
 920  00a4 721a5201      	bset	20993,#5
 922  00a8 2004          	jra	L514
 923  00aa               L314:
 924                     ; 222         SPI->CR2 &= (uint8_t)(~SPI_CR2_CRCEN); /* Disable the CRC calculation*/
 926  00aa 721b5201      	bres	20993,#5
 927  00ae               L514:
 928                     ; 224 }
 931  00ae 81            	ret
 995                     ; 231 uint8_t SPI_GetCRC(SPI_CRC_TypeDef SPI_CRC)
 995                     ; 232 {
 996                     	switch	.text
 997  00af               _SPI_GetCRC:
 999  00af 88            	push	a
1000       00000001      OFST:	set	1
1003                     ; 233     uint8_t crcreg = 0;
1005                     ; 236     assert_param(IS_SPI_CRC_OK(SPI_CRC));
1007                     ; 238     if (SPI_CRC != SPI_CRC_RX)
1009  00b0 4d            	tnz	a
1010  00b1 2707          	jreq	L154
1011                     ; 240         crcreg = SPI->TXCRCR;  /* Get the Tx CRC register*/
...
1031  00c3 81            	ret
1056                     ; 256 void SPI_ResetCRC(void)
1056                     ; 257 {
1057                     	switch	.text
1058  00c4               _SPI_ResetCRC:
1062                     ; 260     SPI_CalculateCRCCmd(ENABLE);
1064  00c4 a601          	ld	a,#1
1065  00c6 add9          	call	_SPI_CalculateCRCCmd
1067                     ; 263     SPI_Cmd(ENABLE);
1069  00c8 a601          	ld	a,#1
1070  00ca ad80          	call	_SPI_Cmd
1072                     ; 264 }
1075  00cc 81            	ret
1099                     ; 271 uint8_t SPI_GetCRCPolynomial(void)
1099                     ; 272 {
1100                     	switch	.text
1101  00cd               _SPI_GetCRCPolynomial:
1105                     ; 273     return SPI->CRCPR; /* Return the CRC polynomial register */
1107  00cd c65205        	ld	a,20997
1110  00d0 81            	ret
1166                     ; 281 void SPI_BiDirectionalLineConfig(SPI_Direction_TypeDef SPI_Direction)
1166                     ; 282 {
1167                     	switch	.text
1168  00d1               _SPI_BiDirectionalLineConfig:
1172                     ; 284     assert_param(IS_SPI_DIRECTION_OK(SPI_Direction));
1174                     ; 286     if (SPI_Direction != SPI_DIRECTION_RX)
1176  00d1 4d            	tnz	a
1177  00d2 2706          	jreq	L325
1178                     ; 288         SPI->CR2 |= SPI_CR2_BDOE; /* Set the Tx only mode*/
1180  00d4 721c5201      	bset	20993,#6
1182  00d8 2004          	jra	L525
1183  00da               L325:
1184                     ; 292         SPI->CR2 &= (uint8_t)(~SPI_CR2_BDOE); /* Set the Rx only mode*/
1186  00da 721d5201      	bres	20993,#6
1187  00de               L525:
1188                     ; 294 }
1191  00de 81            	ret
1312                     ; 304 FlagStatus SPI_GetFlagStatus(SPI_Flag_TypeDef SPI_FLAG)
1312                     ; 305 {
1313                     	switch	.text
1314  00df               _SPI_GetFlagStatus:
1316  00df 88            	push	a
1317       00000001      OFST:	set	1
1320                     ; 306     FlagStatus status = RESET;
1322                     ; 308     assert_param(IS_SPI_FLAGS_OK(SPI_FLAG));
1324                     ; 311     if ((SPI->SR & (uint8_t)SPI_FLAG) != (uint8_t)RESET)
1326  00e0 c45203        	and	a,20995
1327  00e3 2706          	jreq	L306
1328                     ; 313         status = SET; /* SPI_FLAG is set */
1330  00e5 a601          	ld	a,#1
1331  00e7 6b01          	ld	(OFST+0,sp),a
1334  00e9 2002          	jra	L506
1335  00eb               L306:
1336                     ; 317         status = RESET; /* SPI_FLAG is reset*/
1338  00eb 0f01          	clr	(OFST+0,sp)
1340  00ed               L506:
1341                     ; 321     return status;
1343  00ed 7b01          	ld	a,(OFST+0,sp)
1346  00ef 5b01          	addw	sp,#1
1347  00f1 81            	ret
1382                     ; 339 void SPI_ClearFlag(SPI_Flag_TypeDef SPI_FLAG)
1382                     ; 340 {
1383                     	switch	.text
1384  00f2               _SPI_ClearFlag:
1388                     ; 341     assert_param(IS_SPI_CLEAR_FLAGS_OK(SPI_FLAG));
1390                     ; 343     SPI->SR = (uint8_t)(~SPI_FLAG);
1392  00f2 43            	cpl	a
1393  00f3 c75203        	ld	20995,a
1394                     ; 344 }
1397  00f6 81            	ret
1479                     ; 359 ITStatus SPI_GetITStatus(SPI_IT_TypeDef SPI_IT)
1479                     ; 360 {
1480                     	switch	.text
...
1488                     ; 361     ITStatus pendingbitstatus = RESET;
1490                     ; 362     uint8_t itpos = 0;
1492                     ; 363     uint8_t itmask1 = 0;
1494                     ; 364     uint8_t itmask2 = 0;
1496                     ; 365     uint8_t enablestatus = 0;
1498                     ; 366     assert_param(IS_SPI_GET_IT_OK(SPI_IT));
1500                     ; 368     itpos = (uint8_t)((uint8_t)1 << ((uint8_t)SPI_IT & (uint8_t)0x0F));
...
1515                     ; 371     itmask1 = (uint8_t)((uint8_t)SPI_IT >> (uint8_t)4);
1517  0108 7b03          	ld	a,(OFST+1,sp)
1518  010a 4e            	swap	a
1519  010b a40f          	and	a,#15
1520  010d 6b02          	ld	(OFST+0,sp),a
1522                     ; 373     itmask2 = (uint8_t)((uint8_t)1 << itmask1);
...
1537                     ; 375     enablestatus = (uint8_t)((uint8_t)SPI->SR & itmask2);
1539  011e c65203        	ld	a,20995
1540  0121 1402          	and	a,(OFST+0,sp)
1541  0123 6b02          	ld	(OFST+0,sp),a
1543                     ; 377     if (((SPI->ICR & itpos) != RESET) && enablestatus)
...
1551                     ; 380         pendingbitstatus = SET;
1553  0130 a601          	ld	a,#1
1554  0132 6b02          	ld	(OFST+0,sp),a
1557  0134 2002          	jra	L176
1558  0136               L766:
1559                     ; 385         pendingbitstatus = RESET;
1561  0136 0f02          	clr	(OFST+0,sp)
1563  0138               L176:
1564                     ; 388     return  pendingbitstatus;
1566  0138 7b02          	ld	a,(OFST+0,sp)
1569  013a 5b03          	addw	sp,#3
1570  013c 81            	ret
1615                     ; 404 void SPI_ClearITPendingBit(SPI_IT_TypeDef SPI_IT)
1615                     ; 405 {
1616                     	switch	.text
1617  013d               _SPI_ClearITPendingBit:
1619  013d 88            	push	a
1620       00000001      OFST:	set	1
1623                     ; 406     uint8_t itpos = 0;
1625                     ; 407     assert_param(IS_SPI_CLEAR_IT_OK(SPI_IT));
1627                     ; 412     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)(SPI_IT & (uint8_t)0xF0) >> 4));
