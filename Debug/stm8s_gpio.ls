 ...
 108                     ; 54 void GPIO_DeInit(GPIO_TypeDef* GPIOx)
 108                     ; 55 {
 110                     	switch	.text
 111  0000               _GPIO_DeInit:
 115                     ; 56   GPIOx->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
 117  0000 7f            	clr	(x)
 118                     ; 57   GPIOx->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
 120  0001 6f02          	clr	(2,x)
 121                     ; 58   GPIOx->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
 123  0003 6f03          	clr	(3,x)
 124                     ; 59   GPIOx->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
 126  0005 6f04          	clr	(4,x)
 127                     ; 60 }
 130  0007 81            	ret
 370                     ; 72 void GPIO_Init(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, GPIO_Mode_TypeDef GPIO_Mode)
 370                     ; 73 {
 371                     	switch	.text
 372  0008               _GPIO_Init:
 374  0008 89            	pushw	x
 375       00000000      OFST:	set	0
 378                     ; 78   assert_param(IS_GPIO_MODE_OK(GPIO_Mode));
 380                     ; 79   assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
 382                     ; 82   GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
 384  0009 7b05          	ld	a,(OFST+5,sp)
 385  000b 43            	cpl	a
 386  000c e404          	and	a,(4,x)
 387  000e e704          	ld	(4,x),a
 388                     ; 88   if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x80) != (uint8_t)0x00) /* Output mode */
 390  0010 7b06          	ld	a,(OFST+6,sp)
 391  0012 a580          	bcp	a,#128
 392  0014 271d          	jreq	L771
 393                     ; 90     if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x10) != (uint8_t)0x00) /* High level */
 395  0016 7b06          	ld	a,(OFST+6,sp)
 396  0018 a510          	bcp	a,#16
 397  001a 2706          	jreq	L102
 398                     ; 92       GPIOx->ODR |= (uint8_t)GPIO_Pin;
 400  001c f6            	ld	a,(x)
 401  001d 1a05          	or	a,(OFST+5,sp)
 402  001f f7            	ld	(x),a
 404  0020 2007          	jra	L302
 405  0022               L102:
 406                     ; 96       GPIOx->ODR &= (uint8_t)(~(GPIO_Pin));
 ...
 412  0028 f7            	ld	(x),a
 413  0029               L302:
 414                     ; 99     GPIOx->DDR |= (uint8_t)GPIO_Pin;
 ...
 422  0033               L771:
 423                     ; 104     GPIOx->DDR &= (uint8_t)(~(GPIO_Pin));
 ...
 430  003c               L502:
 431                     ; 111   if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x40) != (uint8_t)0x00) /* Pull-Up or Push-Pull */
 433  003c 7b06          	ld	a,(OFST+6,sp)
 434  003e a540          	bcp	a,#64
 435  0040 270a          	jreq	L702
 436                     ; 113     GPIOx->CR1 |= (uint8_t)GPIO_Pin;
 ...
 444  004c               L702:
 445                     ; 117     GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
 ...
 452  0055               L112:
 453                     ; 124   if ((((uint8_t)(GPIO_Mode)) & (uint8_t)0x20) != (uint8_t)0x00) /* Interrupt or Slow slope */
 455  0055 7b06          	ld	a,(OFST+6,sp)
 456  0057 a520          	bcp	a,#32
 457  0059 270a          	jreq	L312
 458                     ; 126     GPIOx->CR2 |= (uint8_t)GPIO_Pin;
 ...
 466  0065               L312:
 467                     ; 130     GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
 ...
 478  006e 85            	popw	x
 479  006f 81            	ret
 525                     ; 142 void GPIO_Write(GPIO_TypeDef* GPIOx, uint8_t PortVal)
 525                     ; 143 {
 526                     	switch	.text
 527  0070               _GPIO_Write:
 529  0070 89            	pushw	x
 530       00000000      OFST:	set	0
 533                     ; 144   GPIOx->ODR = PortVal;
 ...
 541  0076 85            	popw	x
 542  0077 81            	ret
 589                     ; 155 void GPIO_WriteHigh(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 589                     ; 156 {
 590                     	switch	.text
 591  0078               _GPIO_WriteHigh:
 593  0078 89            	pushw	x
 594       00000000      OFST:	set	0
 597                     ; 157   GPIOx->ODR |= (uint8_t)PortPins;
 599  0079 f6            	ld	a,(x)
 ...
 605  007d 85            	popw	x
 606  007e 81            	ret
 653                     ; 168 void GPIO_WriteLow(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 653                     ; 169 {
 654                     	switch	.text
 655  007f               _GPIO_WriteLow:
 657  007f 89            	pushw	x
 658       00000000      OFST:	set	0
 661                     ; 170   GPIOx->ODR &= (uint8_t)(~PortPins);
 ...
 670  0085 85            	popw	x
 671  0086 81            	ret
 718                     ; 181 void GPIO_WriteReverse(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 718                     ; 182 {
 719                     	switch	.text
 720  0087               _GPIO_WriteReverse:
 722  0087 89            	pushw	x
 723       00000000      OFST:	set	0
 726                     ; 183   GPIOx->ODR ^= (uint8_t)PortPins;
 728  0088 f6            	ld	a,(x)
 ...
 734  008c 85            	popw	x
 735  008d 81            	ret
 773                     ; 192 uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx)
 773                     ; 193 {
 774                     	switch	.text
 775  008e               _GPIO_ReadOutputData:
 779                     ; 194   return ((uint8_t)GPIOx->ODR);
 781  008e f6            	ld	a,(x)
 784  008f 81            	ret
 821                     ; 203 uint8_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx)
 821                     ; 204 {
 822                     	switch	.text
 823  0090               _GPIO_ReadInputData:
 827                     ; 205   return ((uint8_t)GPIOx->IDR);
 829  0090 e601          	ld	a,(1,x)
 832  0092 81            	ret
 900                     ; 214 BitStatus GPIO_ReadInputPin(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
 900                     ; 215 {
 901                     	switch	.text
 902  0093               _GPIO_ReadInputPin:
 904  0093 89            	pushw	x
 905       00000000      OFST:	set	0
 908                     ; 216   return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
 910  0094 e601          	ld	a,(1,x)
 911  0096 1405          	and	a,(OFST+5,sp)
 914  0098 85            	popw	x
 915  0099 81            	ret
 993                     ; 226 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
 993                     ; 227 {
 994                     	switch	.text
 995  009a               _GPIO_ExternalPullUpConfig:
 997  009a 89            	pushw	x
 998       00000000      OFST:	set	0
1001                     ; 229   assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
1003                     ; 230   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1005                     ; 232   if (NewState != DISABLE) /* External Pull-Up Set*/
1007  009b 0d06          	tnz	(OFST+6,sp)
1008  009d 2708          	jreq	L374
1009                     ; 234     GPIOx->CR1 |= (uint8_t)GPIO_Pin;
1011  009f e603          	ld	a,(3,x)
1012  00a1 1a05          	or	a,(OFST+5,sp)
1013  00a3 e703          	ld	(3,x),a
1015  00a5 2009          	jra	L574
1016  00a7               L374:
1017                     ; 237     GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
