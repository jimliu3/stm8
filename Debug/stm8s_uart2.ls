 ...
 611  012a               L502:
 612                     ; 147     if ((uint8_t)(Mode & UART2_MODE_RX_ENABLE))
 ...
 632                     ; 162         UART2->CR3 &= (uint8_t)(~UART2_CR3_CKEN); 
 634  0140 72175246      	bres	21062,#3
 636  0144 200a          	jra	L512
 637  0146               L312:
 638                     ; 166         UART2->CR3 |= (uint8_t)((uint8_t)SyncMode & UART2_CR3_CKEN);
 ...
 649  0152 81            	ret
 704                     ; 176 void UART2_Cmd(FunctionalState NewState)
 704                     ; 177 {
 705                     	switch	.text
 706  0153               _UART2_Cmd:
 710                     ; 179     if (NewState != DISABLE)
 712  0153 4d            	tnz	a
 713  0154 2706          	jreq	L542
 714                     ; 182         UART2->CR1 &= (uint8_t)(~UART2_CR1_UARTD);
 716  0156 721b5244      	bres	21060,#5
 718  015a 2004          	jra	L742
 719  015c               L542:
 720                     ; 187         UART2->CR1 |= UART2_CR1_UARTD; 
 722  015c 721a5244      	bset	21060,#5
 723  0160               L742:
 724                     ; 189 }
 727  0160 81            	ret
 859                     ; 206 void UART2_ITConfig(UART2_IT_TypeDef UART2_IT, FunctionalState NewState)
 859                     ; 207 {
 860                     	switch	.text
 ...
 868                     ; 208     uint8_t uartreg = 0, itpos = 0x00;
 872                     ; 211     assert_param(IS_UART2_CONFIG_IT_OK(UART2_IT));
 874                     ; 212     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 876                     ; 215     uartreg = (uint8_t)((uint16_t)UART2_IT >> 0x08);
 878  0163 9e            	ld	a,xh
 879  0164 6b01          	ld	(OFST-1,sp),a
 881                     ; 218     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART2_IT & (uint8_t)0x0F));
 883  0166 9f            	ld	a,xl
 ...
 988  01e7               L163:
 989                     ; 257             UART2->CR6 &= (uint8_t)(~itpos);
...
1074  01fc               L314:
1075                     ; 277         UART2->CR5 &= ((uint8_t)~UART2_CR5_IRLP);
...
1134  020a               L534:
1135                     ; 300         UART2->CR5 &= ((uint8_t)~UART2_CR5_IREN);
...
1218  0218               L764:
1219                     ; 322         UART2->CR4 &= ((uint8_t)~UART2_CR4_LBDL);
...
1460  0253               L306:
1461                     ; 391         UART2->CR3 &= ((uint8_t)~UART2_CR3_LINEN);
...
1520  0261               L526:
1521                     ; 413         UART2->CR5 &= ((uint8_t)(~UART2_CR5_SCEN));
...
1581  026f               L746:
1582                     ; 436         UART2->CR5 &= ((uint8_t)~(UART2_CR5_NACK));
...
1717  0288               L717:
1718                     ; 472         UART2->CR2 &= ((uint8_t)~UART2_CR2_RWU);
...
1813                     ; 497   return (uint16_t)((((uint16_t)UART2->DR) | temp) & ((uint16_t)0x01FF));
...
1831  02b2 81            	ret
1865                     ; 505 void UART2_SendData8(uint8_t Data)
1865                     ; 506 {
1866                     	switch	.text
1867  02b3               _UART2_SendData8:
1871                     ; 508     UART2->DR = Data;
1873  02b3 c75241        	ld	21057,a
1874                     ; 509 }
1877  02b6 81            	ret
1911                     ; 516 void UART2_SendData9(uint16_t Data)
1911                     ; 517 {
1912                     	switch	.text
1913  02b7               _UART2_SendData9:
1915  02b7 89            	pushw	x
1916       00000000      OFST:	set	0
1919                     ; 519     UART2->CR1 &= ((uint8_t)~UART2_CR1_T8);                  
1921  02b8 721d5244      	bres	21060,#6
1922                     ; 522     UART2->CR1 |= (uint8_t)(((uint8_t)(Data >> 2)) & UART2_CR1_T8); 
1924  02bc 54            	srlw	x
1925  02bd 54            	srlw	x
...
1930                     ; 525     UART2->DR   = (uint8_t)(Data);                    
1932  02c7 7b02          	ld	a,(OFST+2,sp)
1933  02c9 c75241        	ld	21057,a
1934                     ; 527 }
1937  02cc 85            	popw	x
1938  02cd 81            	ret
1961                     ; 534 void UART2_SendBreak(void)
1961                     ; 535 {
1962                     	switch	.text
1963  02ce               _UART2_SendBreak:
1967                     ; 536     UART2->CR2 |= UART2_CR2_SBK;
1969  02ce 72105245      	bset	21061,#0
1970                     ; 537 }
1973  02d2 81            	ret
2007                     ; 544 void UART2_SetAddress(uint8_t UART2_Address)
2007                     ; 545 {
2008                     	switch	.text
2009  02d3               _UART2_SetAddress:
2011  02d3 88            	push	a
2012       00000000      OFST:	set	0
2015                     ; 547     assert_param(IS_UART2_ADDRESS_OK(UART2_Address));
2017                     ; 550     UART2->CR4 &= ((uint8_t)~UART2_CR4_ADD);
2019  02d4 c65247        	ld	a,21063
2020  02d7 a4f0          	and	a,#240
2021  02d9 c75247        	ld	21063,a
2022                     ; 552     UART2->CR4 |= UART2_Address;
...
2030  02e4 84            	pop	a
2031  02e5 81            	ret
2065                     ; 561 void UART2_SetGuardTime(uint8_t UART2_GuardTime)
2065                     ; 562 {
2066                     	switch	.text
2067  02e6               _UART2_SetGuardTime:
2071                     ; 564     UART2->GTR = UART2_GuardTime;
2073  02e6 c7524a        	ld	21066,a
2074                     ; 565 }
2077  02e9 81            	ret
2111                     ; 589 void UART2_SetPrescaler(uint8_t UART2_Prescaler)
2111                     ; 590 {
2112                     	switch	.text
2113  02ea               _UART2_SetPrescaler:
2117                     ; 592     UART2->PSCR = UART2_Prescaler;
2119  02ea c7524b        	ld	21067,a
2120                     ; 593 }
2123  02ed 81            	ret
2280                     ; 601 FlagStatus UART2_GetFlagStatus(UART2_Flag_TypeDef UART2_FLAG)
2280                     ; 602 {
2281                     	switch	.text
...
2289                     ; 603     FlagStatus status = RESET;
2291                     ; 606     assert_param(IS_UART2_FLAG_OK(UART2_FLAG));
2293                     ; 609     if (UART2_FLAG == UART2_FLAG_LBDF)
2295  02f0 a30210        	cpw	x,#528
2296  02f3 2610          	jrne	L5511
2297                     ; 611         if ((UART2->CR4 & (uint8_t)UART2_FLAG) != (uint8_t)0x00)
...
2333  0319               L7611:
2334                     ; 632             status = RESET;
2336  0319 0f01          	clr	(OFST+0,sp)
2338  031b 201d          	jra	L3611
2339  031d               L5611:
2340                     ; 635     else if ((UART2_FLAG == UART2_FLAG_LHDF) || (UART2_FLAG == UART2_FLAG_LSF))
...
2349  032b               L7711:
2350                     ; 637         if ((UART2->CR6 & (uint8_t)UART2_FLAG) != (uint8_t)0x00)
...
2362  0338               L1021:
2363                     ; 645             status = RESET;
2365  0338 0f01          	clr	(OFST+0,sp)
2367  033a               L3611:
2368                     ; 663     return  status;
2370  033a 7b01          	ld	a,(OFST+0,sp)
2373  033c 5b03          	addw	sp,#3
2374  033e 81            	ret
2375  033f               L5711:
2376                     ; 650         if ((UART2->SR & (uint8_t)UART2_FLAG) != (uint8_t)0x00)
...
2569                     ; 734     ITStatus pendingbitstatus = RESET;
2571                     ; 735     uint8_t itpos = 0;
2573                     ; 736     uint8_t itmask1 = 0;
2575                     ; 737     uint8_t itmask2 = 0;
2577                     ; 738     uint8_t enablestatus = 0;
2579                     ; 741     assert_param(IS_UART2_GET_IT_OK(UART2_IT));
2581                     ; 744     itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART2_IT & (uint8_t)0x0F));
...
2597                     ; 746     itmask1 = (uint8_t)((uint8_t)UART2_IT >> (uint8_t)4);
2599  038e 7b04          	ld	a,(OFST+2,sp)
2600  0390 4e            	swap	a
2601  0391 a40f          	and	a,#15
2602  0393 6b02          	ld	(OFST+0,sp),a
2604                     ; 748     itmask2 = (uint8_t)((uint8_t)1 << itmask1);
...
2696                     ; 789         if (((UART2->CR6 & itpos) != (uint8_t)0x00) && enablestatus)
