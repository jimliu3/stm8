...
#define ENABLE_TIM1_SelectCOM						0	 /* Disable selectcom function*/
#define ENABLE_TIM1_CCPreloadControl		0	 /* Disable set CCPreload Control function*/
#define ENABLE_TIM1_OCxPreloadConfig  	0  /* Disable OCx Preload Config function*/
#define ENABLE_TIM1_OCxFastConfig				0	 /* Disable OCx Fast Config function*/
#define ENABLE_TIM1_GenerateEvent				0	 /* Disable Generate Event function*/
#define ENABLE_TIM1_OCxPolarityConfig		0	 /* Disable OC Polarity Config function*/
#define ENABLE_TIM1_CCxCmd							0	 /* Disable CCxCmd function*/
#define ENABLE_TIM1_CCxNCmd							0	 /* Disable CCxNCmd function*/
#define ENABLE_TIM1_SelectOCxM					0	 /* Disable Select OCxM function */
#define ENABLE_TIM1_SetAutoreload				0	 /* Disable Set Autore load function*/
#define ENABLE_TIM1_SetCompareX					0	 /* Disable Set Compare function */
#define ENABLE_TIM1_SetICxPrescaler			0	 /* Disable Set ICx Prescaler function*/
#define ENABLE_TIM1_GetCaptureX					0	 /* Disable Get CaptureX function*/
#define ENABLE_TIM1_GetCounter					0	 /* Disable Get Counter function*/
#define ENABLE_TIM1_GetPrescaler				0	 /* Disable Get Prescaler function */
#define ENABLE_TIM1_FlagStatus					0	 /* Disable Flage Status function */
#define ENABLE_TIM1_GetITStatus					0	 /* Disable Get IT status function */
#define ENABLE_TIM1_ClearITPendingBit		0	 /* Disable Clear IT Pending Bit function */
...
#endif //ENABLE_TIM1_SelectCOM

#if ENABLE_TIM1_CCPreloadControl
/**
...
#endif //ENABLE_TIM1_CCPreloadControl
...
#if ENABLE_TIM1_OCxPreloadConfig
...
#endif ENABLE_TIM1_OCxPreloadConfig

#if ENABLE_TIM1_OCxFastConfig
/**
...
#endif //ENABLE_TIM1_OCxFastConfig

#if ENABLE_TIM1_GenerateEvent
/**
...
#endif // ENABLE_TIM1_GenerateEvent

#if ENABLE_TIM1_OCxPolarityConfig
/**
...
#endif //ENABLE_TIM1_OCxPolarityConfig

#if ENABLE_TIM1_CCxCmd
/**
...
#endif //ENABLE_TIM1_CCxCmd

#if ENABLE_TIM1_CCxNCmd
/**
...
#endif //ENABLE_TIM1_CCxNCmd

#if ENABLE_TIM1_SelectOCxM
/**
...
#endif //ENABLE_TIM1_SetAutoreload

#if ENABLE_TIM1_SetCompareX
/**
...
#endif //ENABLE_TIM1_SetCompareX

#if ENABLE_TIM1_SetICxPrescaler
/**
...
#endif //ENABLE_TIM1_SetICxPrescaler

#if ENABLE_TIM1_GetCaptureX
/**
...
#endif //ENABLE_TIM1_GetCaptureX

#if ENABLE_TIM1_GetCounter
/**
...
#endif //ENABLE_TIM1_GetCounter

#if ENABLE_TIM1_GetPrescaler
/**
...
#endif //ENABLE_TIM1_GetPrescaler

#if ENABLE_TIM1_FlagStatus
/**
...
#endif //ENABLE_TIM1_FlagStatus

#if ENABLE_TIM1_GetITStatus
/**
...
#endif //ENABLE_TIM1_GetITStatus

#if ENABLE_TIM1_ClearITPendingBit
/**
...
#endif //ENABLE_TIM1_ClearITPendingBit
/**
